		...
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-tabs">
			...
			<div class="mdl-layout__drawer">
				...
				<nav class="mdl-navigation">
					...
					<?php
						while ($rows=mysqli_fetch_array($data_nemu)) {
					?>
				...
				<section class="mdl-layout__tab-panel is-active" id="fixed-tab-1">
					<div class="page-content" align="center">
						...
						<div class="demo-card-wide mdl-card mdl-shadow--2dp" style="min-height:10px !important;" align="left">
							<div class="mdl-card__supporting-text">
								现在时间是 <?=$info_time?> ，本站已有 <?=mysqli_num_rows($data_list)?> 条留言。
							</div>
						</div>
						<?php
						...
						<div style="margin:8px;" align="center">
							...
							<?php } ?>
							<a class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"><?php echo $read_page ?>/<?php echo $read_totalPage ?></a>
